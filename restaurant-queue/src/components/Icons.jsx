// SVG Icon Components
// Centralized icon library for the restaurant queue application
...
export const QueueIcon = ({ size = 24, className = '', color = 'currentColor' }) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
export const MonitorIcon = ({ size = 24, className = '', color = 'currentColor' }) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 24 24"
...
export const FoodIcon = ({ size = 24, className = '', color = 'currentColor' }) => (
    ...
    >
        <circle cx="12" cy="12" r="10" />
        <path d="M8.5 8.5c1.5-1 3.5-1 5 0" />
        <path d="M12 12v4" />
